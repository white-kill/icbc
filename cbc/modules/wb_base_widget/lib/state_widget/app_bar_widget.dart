...
class AppBarWidget extends StatefulWidget {
  ...
  final Function(int index)? callBackHomeTag;
    ...
    return SizedBox(
      ...
      child: Stack(
        children: [
          ...
          showTab == false
              ...
              : SizedBox(
                  ...
                  child: AppBar(
                    ...
                    titleSpacing: 0,
                    titleTextStyle:
                        TextStyle(fontWeight: FontWeight.bold, fontSize: 18.sw),
         ...
         widget.callBackHomeTag == null?const SizedBox.shrink():Container(
              width: 1.sw,
              height: 36.w,
              margin: EdgeInsets.only(top: navHeight),
              color: Colors.white.withAlpha((percent(navHeight) * 255).toInt()),
              child: Row(
                children: titleList.map((e) {
                  int index = titleList.indexOf(e);
                  return Column(
                    ...
                    children: [
                      BaseText(
                        text: e,
                        color:  (tagIndex == index?Colors.black:Color(0xff666666))
                            .withAlpha((percent(navHeight) * 255).toInt()),
                      ),
                      SizedBox(height: 2.w,),
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: (tagIndex == index?Colors.black:Colors.white)
                              .withAlpha((percent(navHeight) * 255).toInt()),
                    ...
                    tagIndex = index;
                    _scrollDistance = 0;
                    widget.callBackHomeTag?.call(index);
                    setState(() {});
                  });
                }).toList(),
              ))
